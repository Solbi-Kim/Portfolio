...
fetch(`https://script.google.com/macros/s/AKfycbxVqNwI2lo9b2g9i2SWjF9Y1r_VWC28dc3YIBosPuZPXNRoqe2fU0zqnNuEtnYVmwY/exec`)
	.then(res => res.json())
	.then(res => {
...
heartBtn.addEventListener('click', function() {
	...
	// 좋아요 숫자 +1 증가
	fetch(`https://script.google.com/macros/s/AKfycbxVqNwI2lo9b2g9i2SWjF9Y1r_VWC28dc3YIBosPuZPXNRoqe2fU0zqnNuEtnYVmwY/exec?inc=1`)
		.then(res => res.json())
		.then(res => {
